  ...
  return (
    <div className="relative min-h-[100dvh] flex flex-col overflow-hidden bg-background text-foreground selection:bg-primary/30">
      <div className="pointer-events-none fixed inset-0">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(167,46,32,0.14),_transparent_24%),radial-gradient(circle_at_80%_18%,_rgba(227,179,69,0.08),_transparent_18%),linear-gradient(180deg,_rgba(8,10,14,0.94),_rgba(10,12,16,1))]" />
